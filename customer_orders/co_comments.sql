...
comment on column products.unit_price
  is 'Monetary value of one item of this product';
...
comment on table store_orders
  is 'A summary of what was purchased at each location, including summaries of each store, the order status, and overall total';
...
comment on column product_orders.order_status
  is 'Current state of this order';

comment on column product_orders.total_sales
  is 'Total value of orders placed';

comment on column product_orders.order_count
  is 'Total number of orders placed';
